...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="row" style="background-color: #ffffff;">
                <div class="col-md-12 text-center pt-2 border">
                    <a href="{{ route('orders.destroyAll') }}" style="text-decoration: none;"><h6 style="color: #d9d9d9;">Clear Sale</h6></a>
                </div>
            </div>
            <p></p>
            <div class="row" style="background-color: #ffffff;">
            ...
            <div class="row" style="background-color: #ffffff;">
                ...
                <div class="col-md-6 text-center pt-2" style="background-color: #e3e6f3; border-left: 1px solid #ffffff;">
                    <a href="javascript:void(0);" id="printButton" style="text-decoration: none;"><h5 style="color: black;">Print Bill</h5></a>
                </div>
            </div>
            <div class="row" style="background-color: #ffffff;">
